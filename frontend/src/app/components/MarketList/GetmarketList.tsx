...
function GetmarketList() {
  const [selectedMarket, setSelectedMarket] = useState<MarketCreated | null>(
    null
  );
  ...
  return (
    <section className="marketList">
        ...
        <div className="marketList__grid">
          {data?.marketCreateds.map((market) => {
            const isValidImageUrl =
              market.imageUri.startsWith("http://") ||
              market.imageUri.startsWith("https://");
            return (
              <div key={market.marketId} className="marketList__card">
                <div className="betAmount">
                  <div>
                    {isValidImageUrl ? (
                      <Image
                        src={market.imageUri.concat("?raw=true")}
                        alt="Market Image"
                        width={50}
                        height={50}
                      />
                  ...
                  <div className="amountText">
                    <h3
                      ...
                      onClick={() => handleQuestionClick(market)}
                    >
                      {market.question}
                    </h3>
                  </div>
                ...
                <div className="route">
                  ...
                  <div>
                    <button onClick={() => handleAiClick(market.question)}>
                      Ask AI
                    </button>
                  </div>
                </div>
      ...
      <TransactionStatus
        status={status}
        writeContractData={writeContractData}
      />
    </section>
  );
}
